...
# 1 "./adders.h" 1
# 49 "./adders.h"
__attribute__((sdx_kernel("adders", 0))) int adders(int in1, int in2, int in3,int in4,int in5,int in6,int in7);
# 47 "adders.c" 2

__attribute__((sdx_kernel("adders", 0))) int adders(int in1, int in2, int in3,int in4,int in5,int in6,int in7) {
#line 16 "D:/Vivado_HLS_Tutorial/ug871-design-files/Interface_Synthesis/lab1/adders_prj/solution2/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=adders
# 48 "adders.c"

#line 6 "D:/Vivado_HLS_Tutorial/ug871-design-files/Interface_Synthesis/lab1/adders_prj/solution2/directives.tcl"
#pragma HLSDIRECTIVE TOP name=adders
# 48 "adders.c"
