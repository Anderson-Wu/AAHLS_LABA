...
signed int apatb_adders_sw(signed int , signed int , signed int , signed int , signed int , signed int , signed int );
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call i32 @apatb_adders_sw(i32 %%2, i32 %%3, i32 %%4, i32 %%5, i32 %%6, i32 %%7, i32 %%8) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__8 = (unsigned int ) /*tail*/ apatb_adders_sw(llvm_cbe_tmp__1, llvm_cbe_tmp__2, llvm_cbe_tmp__3, llvm_cbe_tmp__4, llvm_cbe_tmp__5, llvm_cbe_tmp__6, llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
